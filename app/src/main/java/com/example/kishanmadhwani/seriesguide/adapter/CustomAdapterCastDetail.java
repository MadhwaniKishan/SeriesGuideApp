...
public class CustomAdapterCastDetail extends BaseAdapter {
        ...
        int size;
        private ArrayList<CastDetailResponse> castlist;
        private static LayoutInflater inflater=null;
        CastDetailResponse temp=null;
        Context mContext;
        String posterUrl,baseUrl="https://image.tmdb.org/t/p/w500";



        public CustomAdapterCastDetail(Context context, ArrayList<CastDetailResponse> data, Resources res, int size) {
            this.castlist = data;
